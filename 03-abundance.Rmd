...
```{r scheme, out.width='49%', fig.show='hold',fig.cap="The general steps required to estimate parameters and their precision using a simple random sampling approach. The blue steps are for sample units of the same size and the grey steps for sample units of different size."}
